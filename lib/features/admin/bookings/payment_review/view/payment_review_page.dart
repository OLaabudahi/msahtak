        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                '**** **** **** $cardLast4',
                style: AdminText.body14(color: const Color(0xFF1565C0), w: FontWeight.w700),
              ),
              if (cardHolder != null && cardHolder!.isNotEmpty)
                Text(cardHolder!, style: AdminText.label12(color: AdminColors.black40)),
              if (cardExpiry != null && cardExpiry!.isNotEmpty)
                Text('Exp: $cardExpiry', style: AdminText.label12(color: AdminColors.black40)),
            ],
          ),
        ),
      ]),
  ...
  Widget build(BuildContext context) {
    if (receiptUrl == null || receiptUrl!.isEmpty) {
      return Container(
        ...
        child: Row(children: [
          const Icon(Icons.receipt_long_outlined, size: 16, color: AdminColors.black40),
          const SizedBox(width: 8),
          Text(context.t('adminNoReceipt'), style: AdminText.body14(color: AdminColors.black40)),
        ]),
      );
    }
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(context.t('adminPaymentReceipt'),
          ...
          child: receiptUrl!.startsWith('data:')
              ...
              : Image.network(
                  ...
                  errorBuilder: (_, __, ___) => Container(
                    ...
                    child: Row(children: [
                      const Icon(Icons.open_in_new, size: 16, color: Color(0xFF1565C0)),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(context.t('adminViewReceipt'),
                            style: AdminText.body14(color: const Color(0xFF1565C0))),
                      ),
                    ]),
                  ),
                ),
