...
import '../data/repos/space_details_repo.dart';
...
class SpaceDetailsBloc extends Bloc<SpaceDetailsEvent, SpaceDetailsState> {
  ...
  Future<void> _onStarted(SpaceDetailsStarted event, Emitter<SpaceDetailsState> emit) async {
  ...
  /// ✅ دالة: تغيير التاب
  void _onTabChanged(SpaceDetailsTabChanged event, Emitter<SpaceDetailsState> emit) {
    emit(state.copyWith(tabIndex: event.index));
  }

  /// ✅ دالة: تغيير مؤشر صور الكاروسيل
  void _onCarouselChanged(SpaceDetailsCarouselChanged event, Emitter<SpaceDetailsState> emit) {
