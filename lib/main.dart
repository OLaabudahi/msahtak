...
void main() async {
  ...
  final source = AuthFirebaseSource();

  runApp(
    MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) => AuthBloc(AuthRepoFirebase(LocalStorageService(),source)),
        ),
        BlocProvider(
          create: (_) =>
...
/// طھط¶ظٹظپ ظ…ط³ط§ط­ط§طھ ط¹ظ…ظ„ طھط¬ط±ظٹط¨ظٹط© ط¥ط°ط§ ظƒط§ظ†طھ workspaces ظپط§ط±ط؛ط©
Future<void> _seedWorkspacesIfEmpty() async {
  final col = FirebaseFirestore.instance.collection('workspaces');
  final snap = await col.limit(1).get();
  if (snap.docs.isNotEmpty) return; // ط§ظ„ط¯ط§طھط§ ظ…ظˆط¬ظˆط¯ط© â€” ظ„ط§ ط´ظٹط،
      ...
      builder: (context, langState) {
        return MaterialApp(
          ...
          theme: ThemeData(
            ...
            // â”€â”€ NavigationBar: ط£ظٹظ‚ظˆظ†ط© ظˆظ†طµ ط§ظ„ظ…ط®طھط§ط± = ط£ط²ط±ظ‚ â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
void main() async {
  ...
  try { await _seedspacesIfEmpty(); } catch (_) {}
      ...
      providers: [
        BlocProvider(
          create: (_) {
            final storage = LocalStorageService();
            final source = AuthFirebaseSource();
            final repo = AuthRepoFirebase(storage,source);
...
/// طھط¶ظٹظپ ظ…ط³ط§ط­ط§طھ ط¹ظ…ظ„ طھط¬ط±ظٹط¨ظٹط© ط¥ط°ط§ ظƒط§ظ†طھ spaces ظپط§ط±ط؛ط©
    ...
    return Consumer<LocalizationService>(
      builder: (context, localization, _) {
        return MaterialApp(
          ...
          // ظ„ظˆ ط¹ظ†ط¯ظƒ delegates/supportedLocales ط¶ظٹظپظٹظ‡ظ…
          // supportedLocales: const [Locale('en'), Locale('ar')],
          // localizationsDelegates: const [...],
